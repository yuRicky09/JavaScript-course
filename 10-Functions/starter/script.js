...
const boardPassengers = function (n, wait) {
  ...
  // 這邊也產生了closure 父層fn的參數也是它的變數 所以子層fn也能讀取
  setTimeout(function () {
...
And now explain to YOURSELF (or someone around you) WHY this worked! Take all the time you need. Think about WHEN exactly the callback function is executed, and what that means for the variables involved(涉及) in this example.
